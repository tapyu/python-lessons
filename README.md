...
# Roles in a Python DevOps
> WARNING: These roles do not refer to specific Python packages or external software. Rather, it refers to functionalities that one desires throughout the development or production (as an end user) phase of a Python software.
